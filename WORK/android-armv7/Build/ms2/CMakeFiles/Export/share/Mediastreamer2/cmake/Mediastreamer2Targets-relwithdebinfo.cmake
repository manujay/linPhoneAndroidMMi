...
set_target_properties(mediastreamer_base PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libmediastreamer_base.so"
  IMPORTED_SONAME_RELWITHDEBINFO "libmediastreamer_base.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS mediastreamer_base )
list(APPEND _IMPORT_CHECK_FILES_FOR_mediastreamer_base "${_IMPORT_PREFIX}/lib/libmediastreamer_base.so" )
...
set_target_properties(mediastreamer_voip PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libmediastreamer_voip.so"
  IMPORTED_SONAME_RELWITHDEBINFO "libmediastreamer_voip.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS mediastreamer_voip )
list(APPEND _IMPORT_CHECK_FILES_FOR_mediastreamer_voip "${_IMPORT_PREFIX}/lib/libmediastreamer_voip.so" )
