...
public class DemoCallActivity extends MmiLinPhoneGenericActivity implements ActivityCompat.OnRequestPermissionsResultCallback, View.OnClickListener {
    ...
    private static DemoCallActivity instance;
    ...
    private boolean isConferenceRunning;
    ...
    public static DemoCallActivity instance() {
        return instance;
    }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.demo_call_activity);
...
//        			}
    ...
    private void displayConferenceParticipant(int index, final LinphoneCall call) {
        ...
        quitConference.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                exitConference(call);
            }
    ...
    public void refreshCallList(Resources resources) {
        ...
        List<LinphoneCall> pausedCalls = LinphoneUtils.getCallsInState(LinphoneManager.getLc(), Arrays.asList(LinphoneCall.State.PausedByRemote));
...
//		Hiding controls to let displayVideoCallControlsIfHidden add them plus the callback
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.video) {
            ...
            LinphoneCall call = (LinphoneCall) view.getTag();
